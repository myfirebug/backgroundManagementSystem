import { Image, Menu, type MenuProps } from "antd";
  ...
  return (
    <animated.div style={props}>
      <div className="bg-black flex flex-col h-screen">
        <Link
          to="/"
          className="flex items-center justify-center text-white p-2 h-10 overflow-hidden"
        >
          <Image
            width={30}
            height={30}
          ...
          />
          {!collapsed ? (
            <h1 className="text-lg font-bold pl-2 leading-10">
              讲者中心管理系统
            </h1>
          ) : null}
        </Link>
